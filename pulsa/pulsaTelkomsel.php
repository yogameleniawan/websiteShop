...
<body>
	...
	<table align="left" width="100%">
		<tr>
				...
				<td width="10px" align="center" style="padding-top: 20px;font-size: 18px"> <b>></b> </td>
				<td  style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #0ec1bb;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=pulsaTelkomsel">Pulsa Telkomsel</a></td>
			
		</tr>
	</table>	
	<table>
		<tr>
			<td colspan="3" align="center" style="padding-bottom: 40px;padding-top: 50px"><b>PULSA TELKOMSEL</b></td>
		</tr>
		...
		<tr>
			<td>
				<a href="index.php?page=PULSA5" style="text-decoration: none;color: black" onclick="javascript:return confirm('Anda yakin ingin membeli?')">
			...
			<td >
				<a href="index.php?page=PULSA20" style="text-decoration: none;color: black"  onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/telkomsel.jpg" width="160px"></td>
					</tr>
			...
			<td >
				<a href="index.php?page=PULSA50" style="text-decoration: none;color: black"  onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/telkomsel.jpg" width="160px"></td>
					</tr>
