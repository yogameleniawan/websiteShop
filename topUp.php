	...
	<font face="Bahnschrift">
		<table align="left" width="100%">
			<tr>
				...
				<td width="10px" align="center" style="padding-top: 20px;font-size: 18px"> <b>></b> </td>
				<td  style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #0ec1bb;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=topUp">Top Up Saldo</a></td>
			</tr>
		</table>
		<table>
			<tr>
				<td colspan="5" align="center" style="padding-top: 40px;padding-bottom: 30px">Top Up Saldo</td>
			</tr>
		</table>
		<table width="350px" style="padding: 5px 5px 5px 5px; border-radius: 10px;box-shadow: 3px 3px 3px grey;">
			<?php
			session_start();
			...
			if(mysqli_num_rows($result)>0){
				...
				{
					?>
					<form method="POST" action="prosesTopUp.php">
					<tr>
						<td colspan="2" align="center" style="color: red;font-size: 12px;font-style: italic;">*Perhatikan besar kecil huruf kode voucher</td>
					</tr>
					<tr align="left">			
						<th>Kode Top Up : </th>
						<td style="font-family: Bahnschrift;font-weight: lighter;padding-left: 5px;padding-bottom: 10px;padding-top: 10px "><input type="text" name="kode" placeholder="XXXXX"></td>
					</tr>
					<tr>
						<td align="center" colspan="2"><input style="background-color: #303e49;border-radius: 10px;color: white;cursor: pointer;" type="submit" name="kirim" value="TOP UP" >
					</form></td>
					</tr>
					<tr>
				...
				{
					case "kodeEmpty";
					echo "Voucher tidak boleh kosong";
					break;
					case "kodeKadaluarsa";
