...
<body>
	...
	<table align="left" width="100%">
		<tr>
				...
				<td  style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #0ec1bb;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=voucherGame">Voucher Game</a></td>
	...
	<table>
		...
		<tr>
			<td>
				<a href="index.php?page=voucherPB" style="text-decoration: none;color: black">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/pb.png"></td>
					</tr>
					<tr>
						<td align="center">Point Blank <br> Voucher</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=voucherPUBG" style="text-decoration: none;color: black">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/pubg.png"></td>
					</tr>
					<tr>
						<td align="center">PUBG Mobile<br> Voucher</td>
					</tr>
				</table>
				</a>
			</td>
