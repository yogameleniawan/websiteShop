...
<body>
	...
	<font face="Bahnschrift">
		...
		<tr>
				...
				<td width="10px" align="center" style="padding-top: 20px;font-size: 18px"> <b>></b>
				<td  style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #0ec1bb;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=KONFIRMASI">Promo</a></td>
