...
<body>
	...
	<font face="Bahnschrift">
		...
		<table>
			<tr>
				<td colspan="5" align="center" style="padding-top: 40px;padding-bottom: 30px">INFO AKUN</td>
			</tr>
		</table>
		<table width="250px" style="padding: 5px 5px 5px 5px; border-radius: 10px;box-shadow: 3px 3px 3px grey;">
			...
			if(mysqli_num_rows($result)>0){
				while($row = mysqli_fetch_array($result))
				{
					...
					<tr align="left">			
						<th>Username</th>
						<td style="font-family: Bahnschrift;font-weight: lighter;padding-left: 20px"><input type="text" name="username" value="<?php echo $row["username"]?>"></td>
					</tr>
					<tr align="left">
						<th>Nama</th>
						<td style="font-family: Bahnschrift;font-weight: lighter;padding-left: 20px"><input type="text" name="nama" value="<?php echo $row["nama"]?>"></td>
					</tr>
					<tr align="left">
					<th>Password</th>	
						<td style="font-family: Bahnschrift;font-weight: lighter;padding-left: 20px"><a href="index.php?page=ubahPassword">Ubah Password</a></td>
					</tr>
					<tr>
						<td align="center" colspan="2"><input style="background-color: #303e49;border-radius: 10px;color: white;cursor: pointer;" type="submit" name="kirim" value="UPDATE" >
					</form></td>
					</tr>
					<tr>
