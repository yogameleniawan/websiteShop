...
<body>
	...
	<table align="left" width="100%">
		<tr>
				...
				<td width="120px" style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #303e49;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=voucherInternet">Voucher Internet</a></td>
				<td width="10px" align="center" style="padding-top: 20px;font-size: 18px"> <b>></b> </td>
				<td  style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #0ec1bb;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=voucherAxis">Voucher Axis</a></td>
			
		</tr>
	</table>	
	<table>
		<tr>
			<td colspan="3" align="center" style="padding-bottom: 40px;padding-top: 50px"><b>VOUCHER AXIS INTERNET</b></td>
		</tr>
		<tr>
			<td>
				<a href="index.php?page=AXIS1" style="text-decoration: none;color: black" onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/axis.jpg" width="160px"></td>
					</tr>
					<tr>
						<td align="center">1,5 GB INTERNET <br>10GB CHAT 60 HARI<br>Rp. 16.785</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=AXIS2" style="text-decoration: none;color: black"  onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/axis.jpg" width="160px"></td>
					</tr>
					<tr>
						<td align="center">5 GB INTERNET <br>10GB CHAT 60 HARI<br>Rp. 30.750</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=AXIS3" style="text-decoration: none;color: black"  onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/axis.jpg" width="160px"></td>
					</tr>
					<tr>
						<td align="center">12 GB INTERNET <br>10GB CHAT 60 HARI<br>Rp. 66.900</td>
					</tr>
				</table>
				</a>
			</td>
