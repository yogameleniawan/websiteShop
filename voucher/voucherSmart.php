...
<body>
	...
	<font face="Bahnschrift">
		...
		<tr>
				...
				<td width="10px" align="center" style="padding-top: 20px;font-size: 18px"> <b>></b> </td>
				<td  style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #0ec1bb;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=voucherSmart">Voucher Smartfren</a></td>
			
		</tr>
	</table>
	<table>
		<tr>
			<td colspan="3" align="center" style="padding-bottom: 40px;padding-top: 50px"><b>VOUCHER SMARTFREN INTERNET</b></td>
		</tr>
		<tr>
			<td>
				<a href="index.php?page=SMART1" style="text-decoration: none;color: black" onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/smart.jpg" width="160px"></td>
					</tr>
					<tr>
						<td align="center">10 GB INTERNET<br>Rp. 30.000</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=SMART2" style="text-decoration: none;color: black"  onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/smart.jpg" width="160px"></td>
					</tr>
					<tr>
						<td align="center">30 GB INTERNET<br>Rp. 40.000</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=SMART3" style="text-decoration: none;color: black"  onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/smart.jpg" width="160px"></td>
					</tr>
					<tr>
						<td align="center">60 GB INTERNET<br>Rp. 100.000</td>
					</tr>
				</table>
				</a>
			</td>
