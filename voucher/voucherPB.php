...
<body>
	...
	<table align="left" width="100%">
		<tr>
				...
				<td width="110px" style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #303e49;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=voucherGame">Voucher Game</a></td>
				<td width="10px" align="center" style="padding-top: 20px;font-size: 18px"> <b>></b> </td>
				<td  style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #0ec1bb;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=voucherPB">Voucher Point Blank</a></td>
			
		</tr>
	</table>	
	<table>
		<tr>
			<td colspan="3" align="center" style="padding-bottom: 40px;padding-top: 50px"><b>VOUCHER GAME ONLINE</b></td>
		</tr>
		<tr>
			<td>
				<a href="index.php?page=PB1200" style="text-decoration: none;color: black" onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/pb.png"></td>
					</tr>
					<tr>
						<td align="center">1.200 PB Cash<br>Rp. 10.000</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=PB2400" style="text-decoration: none;color: black"  onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/pb.png"></td>
					</tr>
					<tr>
						<td align="center">2.400 PB Cash<br>Rp. 20.000</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=PB6000" style="text-decoration: none;color: black"  onclick="javascript:return confirm('Anda yakin ingin membeli?')">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/pb.png"></td>
					</tr>
					<tr>
						<td align="center">6.000 PB Cash<br>Rp. 50.000</td>
					</tr>
				</table>
				</a>
			</td>
