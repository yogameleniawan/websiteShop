...
<body>
	...
	<table align="left" width="100%">
		<tr>
				...
				<td  style="padding-top: 20px;padding-left: 7px"><a style="border-radius: 20px;background-color: #0ec1bb;padding: 6px 6px 6px 6px;text-decoration: none;color: white;font-size: 14px" class="item" href="index.php?page=voucherInternet">Voucher Internet</a></td>
			
		</tr>
	</table>	
	<table>
		<tr>
			<td colspan="4" align="center" style="padding-bottom: 40px;padding-top: 50px"><b>VOUCHER INTERNET</b></td>
		</tr>
		<tr>
			<td>
				<a href="index.php?page=voucherTelkomsel" style="text-decoration: none;color: black">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					...
					<tr>
						<td align="center">Internet<br>Telkomsel</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=voucherIndosat" style="text-decoration: none;color: black">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/indosat.jpg" width="160px"></td>
					</tr>
					<tr>
						<td align="center">Internet<br>Indosat</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=voucherSmart" style="text-decoration: none;color: black">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/smart.jpg" width="140px"></td>
					</tr>
					<tr>
						<td align="center">Internet<br>Smartfreen</td>
					</tr>
				</table>
				</a>
			</td>
			<td >
				<a href="index.php?page=voucherAxis" style="text-decoration: none;color: black">
				<table class="item" style="border-radius: 5px;background-color: white;margin-right: 10px">
					<tr>
						<td ><img src="image/axis.jpg" width="160px"></td>
					</tr>
					<tr>
						<td align="center">Internet<br>Axis</td>
					</tr>
				</table>
				</a>
			</td>
